...
class MariaProfile extends React.Component {
  ...
  render() {
    return (
      ...
      >
        ...
        >
          <Grid item xs={6}>
          <img className="profile-pic" id="maria" src="./imgs/maria.jpeg" alt="Maria Somehow" width="100%"></img>
          </Grid>
          <Grid item xs={6}>
            <h1 className="artist-name">MARIA SOMEHOW</h1>

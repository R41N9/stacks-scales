...
class MichaelProfile extends React.Component {
  ...
  render() {
    return (
      ...
      >
        ...
        >
          <Grid item xs={6}>
          <img className="profile-pic" id="michael" src="./imgs/michael.png" alt="Michael Someway" width="100%"></img>
          </Grid>
          <Grid item xs={6}>
            <h1 className="artist-name">MICHAEL SOMEWAY</h1>
